...
*/
let newAnimals = [];
const displayNames = newAnimals;

zooAnimals.forEach(function(item) {
    return newAnimals.push(`Name: ${item.animal_name}, ${item.state}, Scientific: ${item.scientific_name}.`);
});

console.log('forEach: ', displayNames);
...
console.log('to lower case: ', lowCaseAnimalNames);
...
console.log('Lower population: ', lowPopulationAnimals);
